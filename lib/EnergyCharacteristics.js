...
module.exports = function(hap) {
    // Support being called with either the hap module (Homebridge v2) or directly
    // with the Characteristic class (legacy callers).
    const Characteristic = hap.Characteristic || hap;
