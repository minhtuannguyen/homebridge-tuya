...
class OutletAccessory extends BaseAccessory {
    ...
    constructor(...props) {
        super(...props);
        // Defensive: if `change` never fires (some firmware versions only emit
        // `connect`), still register characteristics once we're connected.
        // Ported from palasinio/homebridge-tuya PR #524.
